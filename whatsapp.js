...
// Initialize Supabase using Environment Variables (We will add these in Vercel)
...
module.exports = async (req, res) => {
    ...
    // When you connect Meta to your URL, they send a GET request to check if you are real.
    if (req.method === 'GET') {
    ...
    // When a retailer sends a message, Meta sends a POST request here.
    if (req.method === 'POST') {
        try {
            const body = req.body;
